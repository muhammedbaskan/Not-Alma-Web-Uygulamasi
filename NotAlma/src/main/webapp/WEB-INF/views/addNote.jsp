...
<!DOCTYPE html>
	...
	<meta name="author" content="Muhammed Baskan" />
	...
	<div id="fh5co-offcanvas">
		...
		<div class="fh5co-bio">
			...
			<h2>Muhammed Baskan</h2>
			<p>Merhaba ben Muhammed Baskan Bilecik Şeyh Edebali Üniversitesi Bilgisayar Mühendisliği bölümü 3.sınıf öğrencisiyim.</p>
	...
	<div class="container-fluid">
		<div class="row fh5co-post-entry single-entry">
			<article class="col-lg-8 col-lg-offset-2 col-md-8 col-md-offset-2 col-sm-8 col-sm-offset-2 col-xs-12 col-xs-offset-0">
                ...
                <h2 class="fh5co-article-title animate-box"><input type="text" id="note_title" placeholder="Başlık"></a></h2>
